...
via [deze Github Classroom](https://classroom.github.com/a/sHB9sPmb). Je kan de repository aanmaken en commits pushen
...
Om correct in te dienen dien je de link naar je GitHub Classroom repository in te zenden
via [Digitap](https://learning.ap.be).

Zorg dat je tijdig bent met indienen, want te late inzendingen worden niet aanvaard. Enkel repositories die aangemaakt
werden in de GitHub Classroom repository worden aanvaard.
