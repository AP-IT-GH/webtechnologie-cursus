...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/CyMmymf8tiNQ4Ws9WmHV/projectopdracht/projectopdracht/praktisch
---
...
Je voert je projectopdracht uit in een repository die je aanmaakt via [deze Github Classroom](https://classroom.github.com/a/uWEd5_9s). Je kan de repository aanmaken en commits pushen tot en met de finale deadline om 16u. Daarna wordt de repository afgesloten en kan je geen wijzigingen meer aanbrengen.
...
Om correct in te dienen dien je de link naar je GitHub Classroom repository in te zenden via [Digitap](https://learning.ap.be).

Zorg dat je tijdig bent met indienen, want te late inzendingen worden niet aanvaard. Enkel repositories die aangemaakt werden in de GitHub Classroom repository worden aanvaard.
...
Na je finale inzending kom je tijdens de laatste lesweek je webshop presenteren. Na je presentatie zul je ook technische vragen over je werk moeten beantwoorden. Deelopdracht 7 vormt je finale inzending. Zorg dat je deze inzending (via Digitap) zeker niet mist!
